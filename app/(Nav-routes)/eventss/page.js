  ...
  return (
    <div className="bg-[#131322] py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <section>
          <h2 className="text-3xl font-bold text-white mb-8">Upcoming Local Events</h2>
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {eventsData.map((event) => (
              <div key={event.name} className="bg-gray-800 rounded-lg shadow-lg overflow-hidden flex flex-col">
        ...
        <section className="mt-20">
          <h2 className="text-3xl font-bold text-white mb-8">Iconic Liverpool Attractions</h2>
          <div className="grid gap-8 md:grid-cols-2">
            {attractionsData.map((attraction) => (
              <div key={attraction.name} className="bg-gray-800 rounded-lg shadow-lg overflow-hidden flex items-center">
