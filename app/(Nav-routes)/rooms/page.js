          ...
          {roomData.map((room, index) => (
            <React.Fragment key={room.id}>
              <button
                ...
                className={`hover:cursor-pointer text-lg md:text-xl font-semibold mx-4 px-2 py-1 transition-colors duration-300 focus:outline-none ${
        ...
        <div key={selectedRoom.id} className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center animate-fade-in">
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="mt-auto pt-8">
                <button className="w-full sm:w-auto inline-block bg-amber-600 text-white font-bold text-lg py-3 px-8 rounded-lg shadow-lg hover:bg-amber-700 transition-all duration-300 transform hover:cursor-pointer hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 lg:mb-50">
                Book Now
                </button>
            </div>
          </div>
