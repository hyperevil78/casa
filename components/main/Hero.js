  ...
  return (
    <main className='relative w-full h-screen min-h-[100vh]'>
      ...
      <div className="relative inset-0 z-10 flex pl-8 pt-8 md:pl-20 md:pt-20 h-full flex-col">
        ...
        <h2 className="text-white text-2xl sm:text-3xl md:text-4xl xl:text-6xl font-bold">EXPERIENCE ELEGANCE
        ...
        <div className='flex md:justify-end mt-10   '>
          <div className='description md:bottom-10 right-5 backdrop-blur-md p-3 md:p-5 md:mr-8 w-11/12 md:w-1/2 text-white border border-white rounded-2xl md:rounded-2xl md:text-xl lg:text-2xl xl:text-3xl absolute bg-black/10'>


            <TextType
              text={["Casa Lumière - Where timeless European charm meets modern luxury.", "Nestled in the heart of the city, Our elegant retreat glows with warm hospitality.", "Exquisite interiors, and moments that feel effortlessly magical."]}
              typingSpeed={35}
              pauseDuration={1000}
              showCursor={true}
              cursorCharacter="|"
