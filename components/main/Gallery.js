  ...
  const gallerySlides = [
    {
      ...
      line1:
        "Experience unparalleled comfort with breathtaking views that captivate the senses.",
    ...
    },
    {
      ...
      line1:
        "Indulge in culinary masterpieces crafted by our world-renowned chefs.",
    ...
    },
    {
      ...
      line1:
        "Rejuvenate your body and soul in our state-of-the-art spa facilities.",
    ...
    },
    {
      ...
      line1:
        "Relax under the stars in our open-air lounge with mesmerizing city views.",
        ...
        <div className="bg-white shadow-2xl rounded-2xl overflow-hidden md:grid md:grid-cols-2 lg:grid-cols-5 md:h-[600px]">
          ...
          <div className="relative w-full h-80 md:h-full group lg:col-span-3">
            ...
            <div className="relative w-full h-full">
              <Image
                src={gallerySlides[currentIndex].img}
                alt={gallerySlides[currentIndex].title}
                fill
                priority
                className="object-cover duration-700 ease-in-out rounded-none"
              />
            </div>
            ...
            <div className="absolute bottom-5 left-0 right-0 flex justify-center gap-2">
              {gallerySlides.map((_, slideIndex) => (
                <div
                  key={slideIndex}
